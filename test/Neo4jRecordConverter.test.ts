...
describe('Neo4jRecordConverter', () => {
  it('should', () => {
    ...
    when(typeConverterMock.convertInteger(anything())).thenReturn(
      'IntegerValue'
    );
    when(typeConverterMock.convertFloat(anything())).thenReturn('FloatValue');
    when(typeConverterMock.convertBoolean(anything())).thenReturn(
      'BooleanValue'
    );
    when(typeConverterMock.convertDateTime(anything())).thenReturn(
      'DateTimeValue'
    );
    ...
    when(typeConverterMock.convertDuration(anything())).thenReturn(
      'DurationValue'
    );
